...
export const ClientMobileNav = ({ clientView, setClientView }) => {
  return (
    <nav className="md:hidden fixed bottom-0 w-full bg-[#121214]/95 backdrop-blur-md border-t border-gray-800/60 flex justify-around items-center p-2 z-50 safe-bottom">
